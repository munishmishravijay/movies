...
API_ID = int(environ.get('API_ID', '20689608'))
API_HASH = environ.get('API_HASH', 'e0b9037612552d79106dbd4ab0997db0')
BOT_TOKEN = environ.get('BOT_TOKEN', '7601669362:AAHgbASa6wTgqbMW-_r8dpXw8Fnqh5SiaIw')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2125931195').split()]
USERNAME = environ.get('USERNAME', "https://t.me/@Munish_Mishra") # ADMIN USERNAME
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MoviesabdSeries:MoviesabdSeries@moviesandseries.b22vo.mongodb.net/?retryWrites=true&w=majority&appName=MoviesAndSeries")
DATABASE_NAME = environ.get('DATABASE_NAME', "MoviesabdSeries")
